...
'Input BAR CODE'
WebUI.setText(findTestObject('Rate Management/Bar Setup/txt_barCode'), 'BAR 2029 The Second')
...
'Input start date'
WebUI.setText(findTestObject('Rate Management/Bar Setup/txt_startDate'), '01/01/2028')

'Input end date'
WebUI.clearText(findTestObject('Rate Management/Bar Setup/txt_endDate'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Rate Management/Bar Setup/txt_endDate'), '01/12/2028')
...
dataRangeIsOverlapWithAnotherBar = WebUI.getText(findTestObject('Rate Management/Bar Setup/txt_Date range is overlap with another bar'))

if (dataRangeIsOverlapWithAnotherBar.contains(dataRangeIsOverlapWithAnotherBar)) {
    WebUI.takeScreenshot()

    WebUI.comment(dataRangeIsOverlapWithAnotherBar)
