...
'Input Nama Company'
WebUI.setText(findTestObject('Profil/Company/txt_name'), 'PT. ABCDE, TBK')
...
'Pilih Market Segment 1'
WebUI.click(findTestObject('Profil/Company/slc_marketSegment1'))

WebUI.click(findTestObject('Profil/Company/BUSINESS GROUP'))

'Pilih Market Segment 2'
WebUI.click(findTestObject('Profil/Company/slc_marketSegment2'))

WebUI.click(findTestObject('Profil/Company/GOVERNMENT'))
...
berhasilSimpan = WebUI.getText(findTestObject('Profil/Company/div_Company profile created successfully'))

if (berhasilSimpan.contains(berhasilSimpan)) {
    WebUI.takeScreenshot()

	WebUI.comment(berhasilSimpan)
    WebUI.comment('Company Profil Berhasil Disimpan')
