...
'Input Nama Company'
WebUI.setText(findTestObject('Profil/Company/txt_name'), 'PT. ABCD, TBK')
...
theSourceFieldIsRequired = WebUI.getText(findTestObject('Profil/Company/txt_theSourceFieldIsRequired'))

if (theSourceFieldIsRequired.contains(theSourceFieldIsRequired)) {
    WebUI.takeScreenshot()

    WebUI.comment(theSourceFieldIsRequired)
