...
'Input Nama Company'
not_run: WebUI.setText(findTestObject('Profil/Company/txt_name'), 'PT. ABC, TBK')
...
gagalDisimpan = WebUI.getText(findTestObject('Profil/Company/txt_The name field is required'))

if (gagalDisimpan.contains(gagalDisimpan)) {
    WebUI.takeScreenshot()

    WebUI.comment(gagalDisimpan)
