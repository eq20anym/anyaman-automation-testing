...
WebUI.setText(findTestObject('Profil/Company/Search/txt_searchCompany'), 'PT. ABCD, TBK')
...
'Input Nama Company'
WebUI.setText(findTestObject('Profil/Company/txt_name'), 'PT. XYZ1, TBK')

'Input Credit Limit'
WebUI.setText(findTestObject('Profil/Company/txt_creditLimit'), '30.000.000')

'Klik tombol save change'
WebUI.click(findTestObject('Profil/Company/btn_saveChange'))

berhasilUpdate = WebUI.getText(findTestObject('Profil/Company/Search/txt_Company profile updated successfully'))
