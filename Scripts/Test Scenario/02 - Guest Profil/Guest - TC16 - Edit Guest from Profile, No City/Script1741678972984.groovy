...
theCityIdFieldMustBeAnInteger = WebUI.getText(findTestObject('val/div_The city id field must be an integer'))

if (theCityIdFieldMustBeAnInteger.contains(theCityIdFieldMustBeAnInteger)) {
    WebUI.takeScreenshot()

    WebUI.comment(theCityIdFieldMustBeAnInteger)
