...
not_run: theBirthOfDateFieldIsRequired = WebUI.getText(findTestObject('val/div_The birth of date field is required'))

not_run: if (theBirthOfDateFieldIsRequired.contains(theBirthOfDateFieldIsRequired)) {
    WebUI.takeScreenshot()

    WebUI.comment(theBirthOfDateFieldIsRequired)
