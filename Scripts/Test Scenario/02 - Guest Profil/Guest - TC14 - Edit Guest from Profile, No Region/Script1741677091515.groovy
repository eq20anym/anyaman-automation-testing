...
theRegionFieldMustBeInteger = WebUI.getText(findTestObject('val/div_The region field must be a string'))

if (theRegionFieldMustBeInteger.contains(theRegionFieldMustBeInteger)) {
    WebUI.takeScreenshot()

    WebUI.comment(theRegionFieldMustBeInteger)
