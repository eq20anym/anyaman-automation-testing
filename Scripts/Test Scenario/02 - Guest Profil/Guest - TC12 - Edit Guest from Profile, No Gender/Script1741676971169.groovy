...
theBirthOfDateFieldIsRequired = WebUI.getText(findTestObject('val/div_The birth of date field is required'))

if (theBirthOfDateFieldIsRequired.contains(theBirthOfDateFieldIsRequired)) {
    WebUI.takeScreenshot()
