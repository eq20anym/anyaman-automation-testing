...
'klik menu profil'
WebUI.click(findTestObject('Reservation FIT/New/Reservation'))

'klik menu profil'
WebUI.click(findTestObject('Reservation FIT/New/Reservation  FIT'))

'klik menu profil'
WebUI.click(findTestObject('Reservation FIT/New/btn_newFIT'))

WebUI.setText(findTestObject('Reservation FIT/New/txt_guestSearch'), 'TAMU TERARIKK')

WebUI.click(findTestObject('Reservation FIT/New/btn_add'))

'input short code'
WebUI.setText(findTestObject('Profil/Guest/txt_shortCode'), 'A4')
...
'Input nama depan'
WebUI.setText(findTestObject('Profil/Guest/txt_firstName'), 'Guest')

'Input nama belakang'
WebUI.setText(findTestObject('Profil/Guest/txt_lastName'), 'Priority 1')
...
WebUI.setText(findTestObject('Profil/Guest/txt_insertID_edit'), '123456789')
...
'pilih status'
not_run: WebUI.click(findTestObject('Profil/Guest/slc_status'))

not_run: WebUI.delay(1)

not_run: WebUI.click(findTestObject('Profil/Guest/VVIP'))
...
'klik tombol save'
not_run: WebUI.click(findTestObject('Profil/Guest/btn_saveChange'))

not_run: profileCreatedSuccessfully = WebUI.getText(findTestObject('Profil/Guest/txt_profileCreatedSuccessfully'))

if (profileCreatedSuccessfully.contains(profileCreatedSuccessfully)) {
    WebUI.takeScreenshot()

    WebUI.comment(profileCreatedSuccessfully)
