...
'Input no identitas'
not_run: WebUI.click(findTestObject('Profil/Guest/NRIC'))

not_run: WebUI.click(findTestObject('Profil/Guest/KTP'))

not_run: WebUI.setText(findTestObject('Profil/Guest/txt_insertID'), '123456789')
...
not_run: if (profileCreatedSuccessfully.contains(profileCreatedSuccessfully)) {
    WebUI.takeScreenshot()
